...
public class SecretaireDaoImpl implements SecretaireDao {
    ...
    public ObservableList<Absence> getAllAbsencesByClasse(String classeText, String promoText, Date date) {
        ...
        try {
            ...
            String query = "SELECT utilisateurs.nom, utilisateurs.prenom, utilisateurs.tel, absences.date, absences.id_absence, absences.justification " +
            ...
            while(resultSet.next()) {
                absence = new Absence(resultSet.getInt("id_absence"), resultSet.getString("nom"), resultSet.getString("prenom"), resultSet.getString("tel") ,resultSet.getString("justification"));
